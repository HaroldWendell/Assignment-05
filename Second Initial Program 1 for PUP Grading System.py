...
def gradingsystem():
    ...
    if grade_percentage >= 97 or grade_percentage == 100:
        ...
        if grade_percentage >= 94 and grade_percentage < 97:
            print('Equivalent Grade/Mark: 1.25')
            print('Description: Excellent')
        else:
            if grade_percentage >= 91 and grade_percentage < 94:
                print('Equivalent Grade/Mark: 1.5')
                print('Description: Very Good')
            else:
                if grade_percentage >= 88 and grade_percentage < 91:
                    print('Equivalent Grade/Mark: 1.75')
                    print('Description: Very Good')
                else:
                    if grade_percentage >= 85 and grade_percentage < 88:
                        print('Equivalent Grade/Mark: 2.0')
                        print('Description: Good')
                    else:
                        if grade_percentage >= 82 and grade_percentage < 85:
                            print('Equivalent Grade/Mark: 2.25')
                            print('Description: Good')
                        else:
                            if grade_percentage >= 79 and grade_percentage < 82:
                                print('Equivalent Grade/Mark: 2.5')
                                print('Description: Satisfactory')
                            else:
                                if grade_percentage >= 76 and grade_percentage < 79:
                                    ...
                                    if grade_percentage == 75:
                                        ...
                                        if grade_percentage >= 65 and grade_percentage < 75:
